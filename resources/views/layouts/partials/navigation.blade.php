            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.index') }}">
                        <x-application-logo class="block h-10 w-auto fill-current text-gray-700" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('settings_index')
                        <x-nav-link :href="route('admin.settings.index')"
                                    :active="str_contains(url()->current(), '/settings')">
                            {{ __('Settings') }}
                        </x-nav-link>
                    @endcan
                    ...
                    @can('users_index')
                        <x-nav-link :href="route('admin.users.index')"
                                    :active="str_contains(url()->current(), '/users')">
                            {{ __('Users') }}
                        </x-nav-link>
                    @endcan
                    ...
                    @can('pages_index')
                        <x-nav-link :href="route('admin.pages.index')"
                                    :active="str_contains(url()->current(), '/pages')">
                            {{ __('Pages') }}
                        </x-nav-link>
                    @endcan
                </div>
